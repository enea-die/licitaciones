...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <li class="breadcrumb-item text-muted">Licitaciones/Cotizaciones Proyectos Cerrados</li>
</ul>
@endsection
    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Listado Licitaciones/Cotizaciones Proyectos Cerrados</h3>
            </div>
        </div>
