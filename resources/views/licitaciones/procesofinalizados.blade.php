...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <li class="breadcrumb-item text-muted">Licitaciones/Cotizaciones Proceso Ejecutados</li>
</ul>
@endsection
    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Listado Licitaciones/Cotizaciones Proceso Ejecutados</h3>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(Auth::user()->can('adjuntar-informe-tecnico') || Auth::user()->can('aprobar-rechazar-informe-tecnico') || Auth::user()->can('ingresar-has') || Auth::user()->can('solicitar-facturar-has') || Auth::user()->can('ingresar-factura-has') || Auth::user()->can('cerrar-proyecto'))
                                                    <a href="{{ url('/licitaciones/continuar', $row->id) }}/procesofinalizados"><button class="btn btn-primary btn-sm">Gestionar</button></a>
                                                @endif    
                                            </td>
                                        </tr>
                                <?php } } ?>
