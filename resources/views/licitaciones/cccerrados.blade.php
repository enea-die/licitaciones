...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <li class="breadcrumb-item text-muted">Licitaciones/Cotizaciones Centro Costo Cerrado</li>
</ul>
@endsection
    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Listado Licitaciones/Cotizaciones Centro Costo Cerrado</h3>
            </div>
        </div>
                                ...
                                <?php if ($licitaciones) {
                                    foreach ($licitaciones as $row) { ?>
                                        <tr>
                                            ...
                                            <td>{{ $row->resp() }}</td>
                                            <td>
                                                <a href="{{ url('/licitaciones/continuar', $row->id) }}/cccerrados"><button class="btn btn-primary btn-sm">Visualizar</button></a>
                                            </td>
                                        </tr>
                                <?php } } ?>
                            </tbody>
