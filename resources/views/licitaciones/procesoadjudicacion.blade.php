...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <li class="breadcrumb-item text-muted">Licitaciones/Cotizaciones Proceso Adjudicación</li>
</ul>
@endsection
    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Listado Licitaciones/Cotizaciones Proceso Adjudicación</h3>
            </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if(Auth::user()->can('ingresar-resultado-adjudicacion') || Auth::user()->can('solicitar-centro-costo') || Auth::user()->can('ingresar-centro-costo') || Auth::user()->can('informar-inicio-servicio'))
                                                    <a href="{{ url('/licitaciones/continuar', $row->id) }}/procesoadjudicacion"><button class="btn btn-primary btn-sm">Gestionar</button></a>
                                                @endif    
                                            </td>
                                        </tr>
                                <?php } } ?>
