...
<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Editar Grupo</h1>
...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <li class="breadcrumb-item text-muted">Editar Grupo</li>
</ul>
@endsection
    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Editar Grupo</h3>
            </div>
        </div>
        <div class="card-body p-9">
            <div class="row mb-7">
                @if(Auth::user()->can('editar-grupos'))
                    <form method="POST" action="{{ route('actualizar-grupo') }}" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body border-top p-9">
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <input type="text" name="nombre" class="form-control form-control-lg form-control-solid" placeholder="Nombre" value="{{ $grupo->nombre_grupo }}">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <select name="id_jefe_operaciones" class="form-control form-control-lg form-control-solid" required>
                                        ...
                                        <option value="{{ $user1->id }}" <?php if($grupo->id_jefe_operaciones == $user1->id) echo "selected"; ?> >{{ $user1->name.' '.$user1->ap_paterno.' '.$user1->ap_materno }}</option>
                                        <?php } } } ?>
                                    </select>
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <select name="id_responsable" class="form-control form-control-lg form-control-solid" required>
                                        ...
                                        <option value="{{ $user3->id }}" <?php if($grupo->id_responsable == $user3->id) echo "selected"; ?> >{{ $user3->name.' '.$user3->ap_paterno.' '.$user3->ap_materno }}</option>
                                        <?php } } } ?>
                                    </select>
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <select name="id_planificacion" class="form-control form-control-lg form-control-solid" required>
                                        ...
                                        <option value="{{ $user5->id }}" <?php if($grupo->id_planificacion == $user5->id) echo "selected"; ?> >{{ $user5->name.' '.$user5->ap_paterno.' '.$user5->ap_materno }}</option>
                                        <?php } } } ?>
                                    </select>
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <select name="id_contabilidad" class="form-control form-control-lg form-control-solid" required>
                                        ...
                                        <option value="{{ $user6->id }}" <?php if($grupo->id_contabilidad == $user6->id) echo "selected"; ?> >{{ $user6->name.' '.$user6->ap_paterno.' '.$user6->ap_materno }}</option>
                                        <?php } } } ?>
                                    </select>
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                ...
                @else
                    <?php \Alert::message('Usted no tiene privilegios para editar grupos', 'warning'); ?>
                    {!! Alert::render() !!}
                @endif
            </div>
        </div>
