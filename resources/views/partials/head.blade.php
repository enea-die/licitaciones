...
<link href="{{ url('extras/css/fullcalendar.bundle.css') }}" rel="stylesheet" type="text/css">
<link href="{{ url('extras/css/jquery.dataTables.min.css') }}" rel="stylesheet" type="text/css">
...
<script src="{{ url('extras/f(1).txt') }}"></script>
...
<script src="{{ url('extras/f(2).txt') }}"></script>
<script src="{{ url('extras/js/jquery.min.js') }}"></script>
<script src="{{ url('extras/js/bootstrap-notify.js') }}"></script>
<link href="{{ url('extras/select2/css/select2.min.css') }}" rel="stylesheet" type="text/css" />
