    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Editar Usuario</h3>
            </div>
        </div>
        <div class="card-body p-9">
            <div class="row mb-7">
                @if(Auth::user()->can('editar-usuarios'))
                    <form method="POST" action="{{ route('actualizar-usuario') }}" class="form fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body border-top p-9">
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ url('extras/svg/blank.svg') }}')">
                                        <?php
                                            if($user->avatar != null){
                                                $ruta_avatar = url('/storage/app/').'/'.$user->avatar; 
                                            }else{
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <input type="text" name="rut" class="form-control form-control-lg form-control-solid" placeholder="Rut" value="{{ $user->rut }}">
                                ...
                                <div class="col-lg-8">
                                    <div class="row">
                                        <div class="col-lg-4 fv-row fv-plugins-icon-container">
                                            <input type="text" name="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Nombre" value="{{ $user->name }}">
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                                        </div>
                                        <div class="col-lg-4 fv-row fv-plugins-icon-container">
                                            <input type="text" name="ap_paterno" class="form-control form-control-lg form-control-solid" placeholder="Apellido paterno" value="{{ $user->ap_paterno }}">
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                                        </div>
                                        <div class="col-lg-4 fv-row fv-plugins-icon-container">
                                            <input type="text" name="ap_materno" class="form-control form-control-lg form-control-solid" placeholder="Apellido materno" value="{{ $user->ap_materno }}">
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <input type="tel" name="phone" class="form-control form-control-lg form-control-solid" placeholder="Numero celular" value="{{ $user->phone }}">
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                            </div>
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <input type="text" name="cargo" class="form-control form-control-lg form-control-solid" placeholder="Cargo" value="{{ $user->cargo }}">
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                            </div>
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    <select name="roles[]" data-control="select2" class="form-control form-control-lg form-control-solid" multiple>
                                        ...
                                        ?>
                                            <option value="{{ $rol->name }}" <?php echo $selected; ?> >{{ $rol->name }}</option>
                                        <?php } } ?>
                                    </select>
                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                </div>
                ...
                @else
                    <?php \Alert::message('Usted no tiene privilegios para editar usuarios', 'warning'); ?>
                    {!! Alert::render() !!}
                @endif
            </div>
        </div>
